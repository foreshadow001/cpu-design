...
VL_ATTR_COLD void VminiRV_SoC_multiplier___stl_sequent__TOP__miniRV_SoC__U_cpu__U_core__U_ALU__U_mul__0(VminiRV_SoC_multiplier* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VminiRV_SoC_multiplier___stl_sequent__TOP__miniRV_SoC__U_cpu__U_core__U_ALU__U_mul__0\n"); );
...
VL_ATTR_COLD void VminiRV_SoC_multiplier___ctor_var_reset(VminiRV_SoC_multiplier* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VminiRV_SoC_multiplier___ctor_var_reset\n"); );
    VminiRV_SoC__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    vlSelf->__PVT__z = VL_SCOPED_RAND_RESET_Q(64, __VscopeHash, 9847161165854524911ull);
    vlSelf->busy = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 6386567572483775230ull);
    vlSelf->product_hi = VL_SCOPED_RAND_RESET_Q(33, __VscopeHash, 15094018861780057995ull);
    vlSelf->product_lo = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 9548805623575670260ull);
    ...
    vlSelf->__PVT__hi_sum = VL_SCOPED_RAND_RESET_Q(34, __VscopeHash, 16859112328922149601ull);
    vlSelf->__PVT__next_hi = VL_SCOPED_RAND_RESET_Q(33, __VscopeHash, 16334334967864654615ull);
    vlSelf->__PVT__next_lo = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 10281755488347335706ull);
